# -*- coding: utf-8 -*-
"""ObjectDetection_FinalVersion.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZPiiRBXHoABVxH-hlQyR2w7XOL1q6B8d
...
def run_detector(detector, path):
  ...
  for entity, score in zip(result['detection_class_entities'], result['detection_scores']):
    # Check if the score is greater than 0.3
    if score > 0.3:
...
def run_detector2(detector, path):
    ...
    # Save the image with boxes and get the relative path for web display
    image_path = save_detected_image(image_with_boxes)
...
def run_detector_withDefinedModel(Path):
  return run_detector2(detector=hub.load(module_handle).signatures['default'], path = Path)
